...
/**
 *  KlikAanKlikUit decoder(new protocol), see description at:
 *  http://wiki.pilight.org/doku.php/arctech_switch
 *  http://www.circuitsonline.net/forum/view/89220
 */
...
r_device newkaku = {
    /* .id             = */ 11,
    /* .name           = */ "New KlikAanKlikUit protocol, on/off events as well as DIM",
